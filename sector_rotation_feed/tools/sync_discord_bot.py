"""Copy bot_token from influencer-feed and set sector-rotation channel_id."""
...
def main() -> None:
    ...
    ap.add_argument("--channel-id", default="1509077723245445211")
    ap.add_argument("--from-stack", default="influencer-feed")
    ap.add_argument("--to-stack", default="sector-rotation-feed")
    args = ap.parse_args()
