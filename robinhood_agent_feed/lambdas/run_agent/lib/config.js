...
export function loadConfig() {
  return {
    ...
    minCashReservePct: parseFloat(process.env.MIN_CASH_RESERVE_PCT || "10"),
    maxOrdersPerRun: parseInt(process.env.MAX_ORDERS_PER_RUN || "8", 10),
    maxSingleOrderPct: parseFloat(process.env.MAX_SINGLE_ORDER_PCT || "25"),
