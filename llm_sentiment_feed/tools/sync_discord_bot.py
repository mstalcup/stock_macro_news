"""Copy bot_token from influencer-feed and set llm-sentiment Discord channel_id."""
...
def main() -> None:
    ...
    ap.add_argument(
        "--channel-id",
        default="1505821117770629311",
        help="LLM sentiment Discord channel id",
    )
    ap.add_argument("--from-stack", default="influencer-feed")
    ap.add_argument("--to-stack", default="llm-sentiment-feed")
    args = ap.parse_args()
