"""Copy bot_token from influencer-feed; set scanner Discord channel_id."""
...
def main() -> None:
    ...
    ap.add_argument("--channel-id", default="1519348792623763687")
    ap.add_argument("--from-stack", default="influencer-feed")
    ap.add_argument("--to-stack", default="premarket-scanner-feed")
    args = ap.parse_args()
